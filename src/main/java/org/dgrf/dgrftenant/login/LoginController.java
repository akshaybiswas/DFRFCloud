 ...
 */
package org.dgrf.dgrftenant.login;
...
public class LoginController implements Serializable {
    ...
    public String adminLogin() {
        ...
        if (userId.equals("dgfoundation") && password.equals("1234")) {
            loginType=2; //admin login type
            userName = "DGRFCloud Super User";
            return "ProductList";
        } else {
    ...
    public String userLogin() {
        ...
        if (userAuthDTO.getResponseCode() == DGRFResponseCode.NO_USER) {
        ...
        if (userAuthDTO.getResponseCode() == DGRFResponseCode.USER_INACTIVE) {
        ...
        if (userAuthDTO.getResponseCode() == DGRFResponseCode.NO_SUBCRIPTION) {
        ...
        if (userAuthDTO.getResponseCode() == DGRFResponseCode.PASSWORD_INCORRECT) {
        ...
        if (userAuthDTO.getResponseCode() == DGRFResponseCode.WRONG_ATTEMPTS_EXCEED) {
